...
static int             fgk_encode_data     (fgk_stream *h,
					    usize_t    n);
static __inline fgk_bit  fgk_get_encoded_bit (fgk_stream *h);
...
static __inline int      fgk_decode_bit      (fgk_stream *h,
					    fgk_bit     b);
...
static __inline void  fgk_swap_ptrs            (fgk_node **one, fgk_node **two);
 ...
 * been received.
 */
static __inline int fgk_decode_bit (fgk_stream* h, fgk_bit b)
{
  XD3_ASSERT (b == 1 || b == 0);
