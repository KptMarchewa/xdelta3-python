/* xdelta3 - delta compression tools and library
   ...
   The initial __XDELTA3_C_HEADER_PASS__ starts first, the ___inline_ and
...
/* Process the __inline pass. */
#define __XDELTA3_C___inline_PASS__
#include "xdelta3.c"
#undef __XDELTA3_C___inline_PASS__
...
#ifdef __XDELTA3_C___inline_PASS__
...
#endif /* __XDELTA3_C___inline_PASS__ */
